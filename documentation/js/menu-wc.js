...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">padro-per-totes-front documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/ButtonSubmit.html" data-type="entity-link" >ButtonSubmit</a>
                            </li>
                            <li class="link">
                                <a href="components/CiutatsComponent.html" data-type="entity-link" >CiutatsComponent</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/InputEmail.html" data-type="entity-link" >InputEmail</a>
                            </li>
                            <li class="link">
                                <a href="components/InputPassword.html" data-type="entity-link" >InputPassword</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/Select.html" data-type="entity-link" >Select</a>
                            </li>
                            <li class="link">
                                <a href="components/Submit.html" data-type="entity-link" >Submit</a>
                            </li>
                            <li class="link">
                                <a href="components/SuperadminDashboard.html" data-type="entity-link" >SuperadminDashboard</a>
                            </li>
                            <li class="link">
                                <a href="components/TextArea.html" data-type="entity-link" >TextArea</a>
                            </li>
                        </ul>
                    </li>
                    <li class="chapter">
                        ...
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="injectables-links"' : 'id="xs-injectables-links"' }>
                                ...
                                <li class="link">
                                    <a href="injectables/Ciutats.html" data-type="entity-link" >Ciutats</a>
                                </li>
                                <li class="link">
                                    <a href="injectables/CiutatsEffects.html" data-type="entity-link" >CiutatsEffects</a>
                                </li>
                                <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            ...
                            <li class="link">
                                <a href="interfaces/CiutatDTO.html" data-type="entity-link" >CiutatDTO</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/CiutatsState.html" data-type="entity-link" >CiutatsState</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/CompoDocConfig.html" data-type="entity-link" >CompoDocConfig</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/ItinerariDTO.html" data-type="entity-link" >ItinerariDTO</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/ItinerariDTO-1.html" data-type="entity-link" >ItinerariDTO</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/PreguntaDTO.html" data-type="entity-link" >PreguntaDTO</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/RespostaDTO.html" data-type="entity-link" >RespostaDTO</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/Session.html" data-type="entity-link" >Session</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/SituacioDTO.html" data-type="entity-link" >SituacioDTO</a>
                            </li>
                            <li class="link">
